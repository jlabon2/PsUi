function Show-UiFolderPicker {
    ...
    .DESCRIPTION
        Displays a modern Windows folder picker dialog. By default uses the Vista file dialog
        configured for folder selection (navigation pane, breadcrumb bar, search built in).
        Use -Simple for the legacy tree-view style picker.
    .PARAMETER Title
