function New-UiSeparator {
    ...
    .DESCRIPTION
        Draws a line between groups of controls. The default Fade style keeps it from reading
        like a 1998 hr tag. Solid is the only hard line - Accent is the same fade in the
        accent color.
    .PARAMETER Style
