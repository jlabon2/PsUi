function New-UiActionCard {
    ...
    .DESCRIPTION
        New-UiButtonCard with -NoOutput baked in. Use this for
        cards that update UI state or open dialogs without needing output display.
        For cards that produce pipeline output or need an output window, use
        New-UiButtonCard instead.
    .PARAMETER Header
