function New-UiProgress {
    ...
    .DESCRIPTION
        Determinate or indeterminate progress bar. Drive it with Set-UiProgress while an
        action runs, or just assign the hydrated variable and let it sync at action end.
    .PARAMETER Variable
