function New-UiDatePicker {
    ...
    .DESCRIPTION
        Labeled date picker with a calendar dropdown, themed to match the rest of the window.
        The selected date is available in actions through -Variable as a DateTime.
    .PARAMETER Variable
