function New-UiInput {
    ...
    .PARAMETER InputType
        ...
        - Email: Blocks whitespace on typing and paste. Pair with -ValidatePattern for the
          real format check.
    ...
    .PARAMETER ErrorMessage
        ...
        Defaults to "Invalid input" for -Validate or "Doesn't match required format" for
        -ValidatePattern.
    ...
    if ($hasValidation) {
        ...
        # Pick the validation event by mode
        if ($ValidateOnChange) {
