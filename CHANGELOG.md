...
- **net452 target**: Added .NET 4.5.2 build target for WinPE and older Windows environments. WebView2 is excluded on this target (not supported). Build script now verifies all three output DLLs (desktop, core, net452). C# backend changes are compatibility, with miinimal functional difference:
